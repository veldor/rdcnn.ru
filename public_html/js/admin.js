                        ...
                        if (!user.length) {
                            ...
                            if (item['conclusionsCount'] > 0) {
                                if (item['conclusion_areas']) {
                                    ...
                                    td += "<td data-conclusion='" + item['id'] + "' class='field-success'><span><span class='glyphicon glyphicon-ok text-success status-icon' data-toggle='tooltip' data-placement='auto' title='" + areasText + "'></span><b>(" + item['conclusionsCount'] + ")</b></span></td>";
                                } else {
                                    td += "<td data-conclusion='" + item['id'] + "' class='field-success'><span><span class='glyphicon glyphicon-ok text-success status-icon'></span><b>(" + item['conclusionsCount'] + ")</b></span></td>";
                                }
                            ...
                            if (conclusionContainer.length) {
                                if (item['conclusionsCount'] > 0) {
                                    ...
                                    if (item['conclusion_areas']) {
                                        ...
                                        conclusionContainer.html("<span class='col-xs-12 visible-xs'><span class='glyphicon glyphicon-ok text-success status-icon tooltip-enabled' data-html='true' data-toggle='tooltip' data-placement='auto' title='" + areasText + "'></span><b>(" + item['conclusionsCount'] + ")</b></span><span class='visible-sm-inline visible-md-inline visible-lg-inline'><span class='glyphicon glyphicon-ok text-success status-icon tooltip-enabled' data-html='true' data-toggle='tooltip' data-placement='auto' title='" + areasText + "'></span><b>(" + item['conclusionsCount'] + ")</b> </span><button class='btn btn-default activator tooltip-enabled' data-action='/delete/conclusions/" + item['id'] + "' data-toggle='tooltip' data-placement='auto' title='Удалить все заключения по обследованию'><span class='glyphicon glyphicon-trash text-danger'></span></button><button class='btn btn-default tooltip-enabled printer'  data-toggle='tooltip' data-placement='auto' title='Распечатать копию' data-names='" + cText + "'><span class='text-info glyphicon glyphicon-print'></span></button>");
                                    } else {
                                        conclusionContainer.html("<span class='col-xs-12 visible-xs'><span class='glyphicon glyphicon-ok text-success status-icon tooltip-enabled' data-html='true' data-toggle='tooltip' data-placement='auto' title='" + areasText + "'></span><b>(" + item['conclusionsCount'] + ")</b></span><span class='visible-sm-inline visible-md-inline visible-lg-inline'><span class='glyphicon glyphicon-ok text-success status-icon tooltip-enabled' data-html='true' data-toggle='tooltip' data-placement='auto' title='" + areasText + "'></span><b>(" + item['conclusionsCount'] + ")</b> </span><button class='btn btn-default activator tooltip-enabled' data-action='/delete/conclusions/" + item['id'] + "' data-toggle='tooltip' data-placement='auto' title='Удалить все заключения по обследованию'><span class='glyphicon glyphicon-trash text-danger'></span></button><button class='btn btn-default tooltip-enabled printer'  data-toggle='tooltip' data-placement='auto' title='Распечатать копию' data-names='" + cText + "'><span class='text-info glyphicon glyphicon-print'></span></button>");
                                    }
