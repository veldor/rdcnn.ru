            ...
            if(answer.hasOwnProperty(i)){
                ...
                if(!user.length){
                    ...
                    let td = $('<tr class="new-element" data-id="' + item['id'] +'">\n' +
                        ...
                        '                <a class="btn btn-default activator" data-action="check-data" data-id="' + item['id'] +'" data-toggle="tooltip" data-placement="auto" title="" data-original-title="Подтвердить загруженные данные"><span class="glyphicon glyphicon-refresh"></span></a>\n' +
                        '            </td>\n' +
